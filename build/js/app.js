...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calendar = __webpack_require__(159);

	var _calendar2 = _interopRequireDefault(_calendar);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_calendar2.default, null), document.getElementById("bke-calendar"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calendarHeader = __webpack_require__(160);

	var _calendarHeader2 = _interopRequireDefault(_calendarHeader);

	var _calendarBody = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calendarStore = __webpack_require__(161);

	var _calendarStore2 = _interopRequireDefault(_calendarStore);

	var _dateUtils = __webpack_require__(174);

	var _calendarActions = __webpack_require__(184);

	var _calendarHeaderIcons = __webpack_require__(185);

	var _calendarHeaderDateSelect = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calendarReducer = __webpack_require__(173);
	...
	function Store() {
	    ...
	    return {
	        calendarData: (0, _calendarReducer2.default)(state.calendarData, action)
	    };
	}

	var CalendarStore = (0, _redux.applyMiddleware)(_reduxThunk2.default)(_redux.createStore)(Store);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = {
	    currentDate: (0, _dateUtils.getCurrentDate)().date,
	    currentMonth: (0, _dateUtils.getCurrentDate)().month,
	    currentYear: (0, _dateUtils.getCurrentDate)().year,
	...
	function calendarData() {
	    ...
	    switch (action.type) {
	        ...
	        case "CURRENTEVENTUPDATE":
	            return Object.assign({}, state, {
	                currentEvent: Array.from(action.state.classList).filter(function (cls) {
	                    return ["football", "cricket", "rugby", "horse-racing", "music", "misc"].find(function (evt) {
	                        return evt === cls;
	                    });
	                }).pop()
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getDaysInMonths = getDaysInMonths;
	...
	function getFullDate(y, m) {
	    var d = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];
	...
	function logDays(y, m) {
	    var daysInMonth = getDaysInMonths(y, m) + 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), (function() { return this; }()), __webpack_require__(177)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CalendarHeaderIcons = undefined;
	...
	var CalendarHeaderIcons = exports.CalendarHeaderIcons = function CalendarHeaderIcons(props) {
	    return _react2.default.createElement(
	        "div",
	        null,
	        _react2.default.createElement(
	            "span",
	            { className: (0, _domUtils.classNames)({
	                    "icon": true,
	                    "football": true,
	                    "selected": props.currentEvent === "football"
	                }) },
	            _react2.default.createElement(
	                "svg",
	        ...
	        _react2.default.createElement(
	            ...
	            { className: (0, _domUtils.classNames)({
	                    "icon": true,
	                    "cricket": true,
	                    "selected": props.currentEvent === "cricket"
	                }) },
	            _react2.default.createElement(
	                "svg",
	        ...
	        _react2.default.createElement(
	            ...
	            { className: (0, _domUtils.classNames)({
	                    "icon": true,
	                    "rugby": true,
	                    "selected": props.currentEvent === "rugby"
	                }) },
	            _react2.default.createElement(
	                "svg",
	        ...
	        _react2.default.createElement(
	            ...
	            { className: (0, _domUtils.classNames)({
	                    "icon": true,
	                    "horse-racing": true,
	                    "selected": props.currentEvent === "horse-racing"
	                }) },
	            _react2.default.createElement(
	                "svg",
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "g",
	                        null,
	                        _react2.default.createElement("path", { d: "M358.863,297.232l22.686-51.603c-4.118-0.257-8.221-0.77-12.29-1.788c-23.681-5.94-41.382-24.564-53.669-44.665h-23.388 c2.98,10.368,1.283,21.472-4.645,30.444l-46.354,70.688c-6.877,10.462-18.443,16.704-30.976,16.704 c-7.228,0-14.229-2.1-20.286-6.065c-17.064-11.2-21.821-34.195-10.621-51.243l22.783-34.762l-26.246-12.105 c-6.519-3.006-11.855-7.756-15.62-13.662h-15.335c-16.055,0-30.572,6.075-41.886,15.775 c-15.766-10.855-73.755-45.449-92.521,18.372c-19.642,66.738,25.559,78.09-8.779,108.341c-1.81,1.603-2.244,4.255-1.041,6.354 c1.219,2.091,3.732,3.044,6.024,2.266c16.296-5.512,38.118-22.584,45.94-73.378c5.268-34.306,22.159-46.355,36.518-45.289 c-5.515,9.518-8.913,20.42-8.913,32.214c0,17.81,7.211,33.937,18.862,45.626l-24.709,37.766l-1.312,1.989 c-1.862,2.844-2.855,6.288-2.663,9.934l5.944,108.078c0.306,5.383,4.247,10.079,9.777,11.088 c6.487,1.194,12.721-3.109,13.907-9.598l11.888-64.87l19.051,66.049c1.509,5.182,6.395,8.876,12.021,8.618 c6.6-0.295,11.695-5.872,11.405-12.465l-4.34-96.765l28.169-40.797h90.947l18.814,37.631l-15.223,98.569 c-0.9,5.815,2.32,11.697,8.044,13.907c6.6,2.548,14.02-0.736,16.565-7.337l31.277-80.951l15.495,79.188 c1.154,5.914,6.523,10.215,12.692,9.871c6.761-0.384,11.921-6.161,11.534-12.915L358.863,297.232z" })
	                    ),
	                    _react2.default.createElement("path", { d: "M259.778,69.781c17,0,30.799-13.797,30.799-30.821c0-17.026-13.799-30.822-30.799-30.822 c-17.048,0-30.826,13.796-30.826,30.822C228.952,55.984,242.73,69.781,259.778,69.781z" }),
	                    _react2.default.createElement(
	                        "g",
	                        null,
	                        _react2.default.createElement("path", { d: "M479.632,137.745l-56.18-47.108l4.79-44.498c0.193-1.906-0.816-3.74-2.53-4.591c-1.732-0.849-3.8-0.529-5.176,0.794 l-25.778,24.66l-18.368,41.116l-29.113,43.672c8.365,21.102,20.512,40.955,33.988,44.313c6.873,1.713,15.508-0.963,25.268-7.291 l10.991-25.021l27.815,12.435c-25.973,28.552-48.9,40.66-68.065,35.788c-29.165-7.29-46.869-53.67-53.617-79.725 c0.788-2.707,0.993-5.615-0.049-8.476c-2.034-5.584-7.303-9.029-12.913-9.029c-1.568,0-3.157,0.271-4.71,0.832l-36.195,13.204 l-12.242-27.006c0.004-0.011,0.009-0.023,0.013-0.034c2.195-5.776,1.979-12.191-0.596-17.808 c-2.575-5.617-7.297-9.971-13.107-12.075l-2.54-0.92c-11.4-4.128-24.009,1.246-28.953,12.317 c-8.856,19.827-23.534,52.433-39.712,87.315c-4.773,10.326-0.253,22.559,10.078,27.335l43.535,20.077l-33.23,50.682 c-6.25,9.52-3.588,22.289,5.911,28.53c3.48,2.276,7.404,3.372,11.281,3.372c6.7,0,13.284-3.251,17.257-9.3l46.359-70.68 c3.297-5.007,8.352-22.238-7.543-29.472c-10.336-4.704-35.98-16.659-35.98-16.659l13.557-36.236 c6.777,14.949,9.021,21.479,17.178,21.479c7.77,0,21.117-6,48.727-16.232c7.803,26.688,26.761,75.214,63.467,84.42 c4.07,1.018,8.188,1.53,12.387,1.53c23.475,0,49.113-16.065,76.434-47.525c3.044,0.143,6.104-0.265,9.004-1.371 c5.53-2.115,9.982-6.336,12.387-11.737l2.196-4.902C489.71,154.825,487.257,144.137,479.632,137.745z" })
	                    )
	                ),
	                _react2.default.createElement("g", null),
	                _react2.default.createElement("g", null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _eventTip = __webpack_require__(189);

	var _eventList = __webpack_require__(190);

	var _eventList2 = _interopRequireDefault(_eventList);

	var _calendarOverlay = __webpack_require__(191);
	...
	var CalendarBody = function (_Component) {
	    ...
	    function CalendarBody() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CalendarBody).call(this));
	    ...
	    _createClass(CalendarBody, [{
	        ...
	        value: function closeEventList(evt) {
	            ...
	            var target = evt.target || evt.srcElement;
	            var selectedEventIndex = target.getAttribute("data-event-index");
	            if (selectedEventIndex) {
	                var selectedEventData = JSON.parse(target.getAttribute("data-event-list-data"));
	                var eventData = (0, _domUtils.getEventDataFromElement)(selectedEventData[Number(selectedEventIndex)]);
	        ...
	        value: function createDates() {
	            ...
	            var daysInMonth = (0, _dateUtils.getDaysInMonths)(currentYear, currentMonth);
	            ...
	            for (var _i = 0, len = listItems.length; _i < len; _i += 7) {
	                lists.push(_react2.default.createElement(
	                    "ul",
	                    { className: "dates", key: "dates" + _i * 7 },
	                    " ",
